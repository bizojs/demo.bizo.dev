...
<nav class="flex items-center justify-between py-3 px-5 mb-10 rounded-md bg-nav-light/80 dark:bg-nav-dark/50">
   ...
   >
      <button type="submit" class="cursor-pointer select-none items-center rounded">
         ...
         >
         <span
            class="flex p-2 items-center justify-center rounded hover:bg-btn-light/80 dark:hover:bg-btn-dark/60 transition">
            {#if dark}
               <svg
                  width="20"
                  height="20"
